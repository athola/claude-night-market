...
Claude Night Market exposes 23 plugins through CLI
commands, Python packages, and skill-based APIs. The
inventory below is the canonical surface; per-plugin
details follow in the next section.

## API Inventory

The ecosystem includes 135 CLI commands, 198 modular
...
|--------|---------|----------|--------|--------|----------------|-----------|
| abstract | 1.9.18 | 18 | 15 | 6 | Yes | abstract-skills |
| archetypes | 1.9.18 | 0 | 15 | 0 | No | - |
| attune | 1.9.18 | 11 | 14 | 2 | No | - |
| cartograph | 1.9.18 | 1 | 7 | 1 | No | - |
| conjure | 1.9.18 | 0 | 4 | 0 | No | quota-tracker, usage-logger, delegator |
| conserve | 1.9.18 | 6 | 15 | 5 | No | - |
| egregore | 1.9.18 | 5 | 4 | 2 | No | - |
| gauntlet | 1.9.18 | 6 | 7 | 1 | Yes | - |
| herald | 1.9.18 | 0 | 0 | 0 | No | - |
| hookify | 1.9.18 | 6 | 2 | 0 | No | - |
| imbue | 1.9.18 | 5 | 16 | 1 | No | - |
| leyline | 1.9.18 | 3 | 24 | 0 | Yes | - |
| memory-palace | 1.9.18 | 5 | 9 | 4 | Yes | - |
| minister | 1.9.18 | 3 | 3 | 0 | Yes | - |
| oracle | 1.9.18 | 1 | 1 | 0 | Yes | - |
| parseltongue | 1.9.18 | 3 | 4 | 4 | Yes | parseltongue |
| pensive | 1.9.18 | 14 | 15 | 6 | Yes | - |
| phantom | 1.9.18 | 1 | 1 | 1 | Yes | - |
| sanctum | 1.9.18 | 21 | 19 | 9 | Yes | - |
| scribe | 1.9.18 | 9 | 11 | 5 | Yes | - |
| scry | 1.9.18 | 2 | 4 | 1 | No | - |
| spec-kit | 1.9.18 | 11 | 3 | 3 | Yes | - |
| tome | 1.9.18 | 4 | 8 | 5 | Yes | - |
...
Plugins are validated by `ruff`, `mypy`, and `bandit` in CI; the
`make validate-all` target runs the same gates locally. Directory
structure is verified by `abstract:validate-plugin` and the
`/sanctum:update-plugins` audit. Current focus: normalizing command
naming across plugins and clarifying export patterns for cross-plugin
dependencies.
