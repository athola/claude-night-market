...
with public APIs. We also maintain 53 executable hooks.

| Plugin | Version | Commands | Skills | Agents | Python Package | CLI Entry |
|--------|---------|----------|--------|--------|----------------|-----------|
| abstract | 1.9.12 | 18 | 15 | 6 | Yes | abstract-skills |
| archetypes | 1.9.12 | 0 | 14 | 0 | No | - |
| attune | 1.9.12 | 10 | 13 | 2 | No | - |
| cartograph | 1.9.12 | 1 | 7 | 1 | No | - |
| conjure | 1.9.12 | 0 | 4 | 0 | No | quota-tracker, usage-logger, delegator |
| conserve | 1.9.12 | 5 | 13 | 5 | No | - |
| egregore | 1.9.12 | 5 | 4 | 2 | No | - |
| gauntlet | 1.9.12 | 6 | 7 | 1 | Yes | - |
| herald | 1.9.12 | 0 | 0 | 0 | No | - |
| hookify | 1.9.12 | 6 | 2 | 0 | No | - |
| imbue | 1.9.12 | 5 | 13 | 1 | No | - |
| leyline | 1.9.12 | 3 | 22 | 0 | Yes | - |
| memory-palace | 1.9.12 | 5 | 7 | 4 | Yes | - |
| minister | 1.9.12 | 3 | 2 | 0 | Yes | - |
| oracle | 1.9.12 | 1 | 1 | 0 | Yes | - |
| parseltongue | 1.9.12 | 3 | 4 | 4 | Yes | parseltongue |
| pensive | 1.9.12 | 13 | 14 | 5 | Yes | - |
| phantom | 1.9.12 | 1 | 1 | 1 | Yes | - |
| sanctum | 1.9.12 | 19 | 18 | 9 | Yes | - |
| scribe | 1.9.12 | 9 | 11 | 5 | Yes | - |
| scry | 1.9.12 | 2 | 4 | 1 | No | - |
| spec-kit | 1.9.12 | 10 | 3 | 3 | Yes | - |
| tome | 1.9.12 | 4 | 7 | 4 | Yes | - |
...
`make validate` target runs the same gates locally. Directory
