# Minister Overview (GitHub-Native)

This repo-level overview mirrors `plugins/minister/docs/overview.md`. Edit that file first, then copy the content here so both docs stay aligned.
