...
| SAN-001 | STALE-FIXED | `update_version_field` generic helper already present; `update_pyproject_version`, `update_package_json_version`, etc. delegate to it. Deduplication already applied in a prior session. |
