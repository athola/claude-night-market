...
- **Anti-Rationalization Patterns**: See abstract:skill-authoring anti-rationalization module
- **Enforcement Language**: See abstract:shared-patterns workflow-patterns module
