...
- **Normalization**: Vector normalization for scale invariance (see abstract:skills-eval methodology)
...
**Documentation**: See abstract:skills-eval multi-metric evaluation methodology for the complete mathematical foundation.
...
See abstract:skills-eval sensitivity analysis for implementation details.
