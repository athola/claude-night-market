...
- Trigger Patterns (abstract shared-modules) - Description field templates
- Enforcement Language (abstract shared-modules) - Intensity calibration
- Anti-Rationalization (abstract shared-modules) - Bypass prevention
- Trigger Isolation Analysis (abstract:skills-eval) - Evaluation criteria
