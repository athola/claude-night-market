...
1. **[Installation](installation.md)**: Add the marketplace and install plugins
2. **[Your First Plugin](first-plugin.md)**: Hands-on tutorial with sanctum
3. **[Quick Start Guide](quick-start.md)**: Common workflows and patterns
