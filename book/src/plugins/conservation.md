...
Conservation helps you work efficiently within Claude's context limits. It automatically loads optimization guidance at session start and provides tools for monitoring and reducing context usage.
