...
description: |
  Monitor and optimize CPU/GPU usage with load measurement
  and cost-effective validation strategies.
location: plugin
token_budget: 400  # Conservative for performance monitoring
