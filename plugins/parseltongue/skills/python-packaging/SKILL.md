...
description: 'Consult this skill for Python package creation and distribution. Use when creating Python packages, configuring pyproject.toml, setting up entry points, publishing to PyPI, CI/CD for packages.'
version: 1.7.1
globs: "**/*.py"
alwaysApply: false
category: packaging
