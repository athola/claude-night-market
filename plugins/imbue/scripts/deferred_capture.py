...
imbue-specific defaults and context enrichment.

Usage:
    python deferred_capture.py --title TITLE --source SOURCE
                               --context CONTEXT [options]
    python deferred_capture.py --title "My idea" --source scope-guard
...
# ---------------------------------------------------------------------------
# Label taxonomy (imbue-relevant labels)
# ---------------------------------------------------------------------------
...
def enrich_context(source: str, context: str) -> str:
    """Apply imbue-specific context enrichment."""
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Create a GitHub issue for a deferred item (imbue).",
    )
    parser.add_argument(
        "--title",
        required=True,
    ...
    parser.add_argument(
        "--source",
        required=True,
        help="Origin skill (e.g. scope-guard, feature-review)",
    )
