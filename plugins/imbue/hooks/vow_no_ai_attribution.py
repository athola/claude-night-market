...
#
# These are scoped to attribution contexts (trailer lines, prose like
# "by Claude/Anthropic", URLs). Bare company or package names are NOT
# matched so dependency commits like "chore: add anthropic>=0.40"
# or "feat: wire anthropic client" pass through cleanly.
