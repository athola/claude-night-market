...
class TestSanctumValidationReport:
    ...
    def test_report_invalid_when_errors_exist(self) -> None:
...
class TestSanctumValidatorFullPlugin:
    ...
    @pytest.mark.integration
    def test_validates_real_sanctum_plugin(self, sanctum_plugin_root) -> None:
    ...
    @pytest.mark.integration
    def test_collects_all_errors(self, tmp_path) -> None:
    ...
    @pytest.mark.integration
    def test_returns_component_results(self, temp_full_plugin) -> None:
...
class TestSanctumValidatorSkillScanning:
    ...
    @pytest.mark.integration
    def test_reports_skill_metadata(self, temp_full_plugin) -> None:
    ...
    @pytest.mark.integration
    def test_scans_real_sanctum_skills(self, sanctum_plugin_root) -> None:
...
class TestSanctumValidatorCommandScanning:
    ...
    @pytest.mark.integration
    def test_scans_real_sanctum_commands(self, sanctum_plugin_root) -> None:
...
class TestSanctumValidatorAgentScanning:
    ...
    @pytest.mark.integration
    def test_scans_real_sanctum_agents(self, sanctum_plugin_root) -> None:
...
class TestSanctumValidatorErrorCollection:
    ...
    @pytest.mark.integration
    def test_counts_totals(self, temp_full_plugin) -> None:
...
class TestSanctumValidatorReport:
    ...
    @pytest.mark.integration
    def test_report_has_plugin_result(self, temp_full_plugin) -> None:
    ...
    @pytest.mark.integration
    def test_minimal_plugin_validation(self, tmp_path) -> None:
