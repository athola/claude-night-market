...
class TestAgentContentValidation:
    ...
    def test_validates_valid_agent(self, sample_agent_content):
    ...
    def test_requires_main_heading(self):
...
"""
    ...
    def test_warns_when_missing_capabilities(self):
...
class TestAgentFileValidation:
    ...
    def test_validates_existing_agent_file(self, temp_agent_file):
    ...
    def test_extracts_agent_name_from_heading(self, sample_agent_content, tmp_path):
...
class TestAgentCapabilityExtraction:
    ...
    def test_extracts_capabilities(self, sample_agent_content):
    ...
    def test_returns_empty_when_no_capabilities_section(self):
