...
class TestCommitMessagesSkill:
    ...
    def test_includes_breaking_change_indicator_when_needed(self) -> None:
...
"""
    ...
    def test_follows_conventional_commit_specification(self) -> None:
    ...
    def test_handles_empty_staged_changes(self) -> None:
    ...
    def test_handles_binary_files_in_staged_changes(self) -> None:
    ...
    class TestCommitMessageQuality:
        ...
        def test_limits_subject_line_length(self) -> None:
            """GIVEN a commit message being generated
            WHEN the subject line is created
...
The authentication flow uses JWT tokens for session management."""
        ...
        def test_explains_what_and_why_in_commit_body(self) -> None:
