...
usage: /pr-wrapper [--no-code-review] [--reviewer-scope strict|standard|lenient] [destination-file]
extends: "superpowers:receiving-code-review"
---

# Enhanced PR Preparation Wrapper
...
- Existing `/pr` command continues to work
- Wrapper adds code review without breaking changes
...
/pr-wrapper --no-code-review

# Strict review for critical changes
/pr-wrapper --reviewer-scope strict

# Custom output location
/pr-wrapper docs/changes/pr-feature-x.md
```

## Implementation Details

The wrapper orchestrates these skills in sequence:
...
# Gradual adoption
/pr-wrapper --no-code-review  # Start here
/pr-wrapper                   # Full migration
```
