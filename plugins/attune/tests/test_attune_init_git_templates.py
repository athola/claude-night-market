"""Tests for attune_init git initialization and template copying.

Covers:
- TestInitializeGit
- TestCopyTemplates (basic behavior)
- TestAttuneInitBehavior (BDD scenarios)
"""
...
class TestInitializeGit:
    ...
    def test_initialize_git_force_reinitializes(self, mock_run, git_project):
        """Given a project with git and force=True, when initializing git,
        then reinitializes.
        """
        # Given
        mock_run.return_value = Mock(returncode=0)
...
class TestCopyTemplates:
    ...
    def test_copy_templates_handles_workflow_paths(
        ...
        """Given workflow templates, when copying, then creates
    ...
    def test_copy_templates_returns_empty_for_missing_language(
        ...
        """Given non-existent language templates, when copying, then returns
        empty list.
        """
        # Given
        templates_root = tmp_path / "templates"
    ...
    def test_copy_templates_prompts_for_overwrite(
        ...
        """Given existing file and no force, when copying, then prompts for
        overwrite.
        """
        # Given
        templates_root = tmp_path / "templates"
    ...
    def test_copy_templates_force_overwrites_existing(
        ...
        """Given existing file and force=True, when copying, then overwrites
        without prompt.
        """
        # Given
        templates_root = tmp_path / "templates"
