...
attune-specific defaults and context enrichment.

Usage:
    python deferred_capture.py --title TITLE --source SOURCE
                               --context CONTEXT [options]
    python deferred_capture.py --title "My idea" --source war-room
...
# ---------------------------------------------------------------------------
# Label taxonomy (attune-relevant labels)
# ---------------------------------------------------------------------------
...
def enrich_context(source: str, context: str) -> str:
    """Apply attune-specific context enrichment."""
    if source == "war-room":
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Create a GitHub issue for a deferred item (attune).",
    )
    parser.add_argument(
        "--title",
        required=True,
