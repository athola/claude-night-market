...
def _detect_breaking_changes(files: list[str]) -> list[dict[str, Any]]:
    """Detect breaking changes in a list of files (not yet implemented).

    TODO: Implement breaking change detection. Planned analyses:
    ...
    """
    raise NotImplementedError("Breaking change detection not yet implemented")
