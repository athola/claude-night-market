...
class TestSkillDescriptionBestPractices:
    ...
    def test_skill_description_includes_what_it_does(self, skill_files):
    ...
    def test_skill_description_includes_when_to_use(self, skill_files):
    ...
    def test_skill_description_not_too_vague(self, skill_files):
...
class TestSkillConflictAvoidance:
    ...
    def test_skills_have_distinct_trigger_terms(self, all_skill_descriptions):
...
class TestHookScopeGuideSkill:
    ...
    def test_skill_has_valid_frontmatter(self, skill_path):
    ...
    def test_skill_description_differentiates_from_hookify(self, skill_path):
    ...
    def test_skill_content_covers_three_scopes(self, skill_path):
    ...
    def test_skill_includes_decision_framework(self, skill_path):
