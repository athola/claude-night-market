...
class RustReviewSkill(BaseReviewSkill):
    ...
    def analyze_builtin_preference(
        ...
        for i, line in enumerate(lines):
            ...
            # Check conversion function patterns
            for (
                pattern,
                trait_name,
                recommendation,
            ...
            # Check error conversion patterns
            for (
                pattern,
                trait_name,
                recommendation,
        ...
        # Check combinator patterns (may span multiple lines,
        # so join content for multiline matching)
        joined = "\n".join(lines)
        for (
            pattern,
            lint_name,
